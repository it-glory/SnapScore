    ...
    <head>
        ...
        <style>
            ...
            .bento-card { background: rgba(255, 255, 255, 0.5); backdrop-filter: blur(20px); border: 1px solid var(--glass-border); border-radius: 30px; padding: 30px; transition: 0.3s; }
            ...
            .progress-bar {
                ...
                box-shadow: 0 0 15px var(--primary-liquid);
            }
        ...
        <div id="upload-screen" class="screen">
            <div class="container">
                ...
                <div class="slider-section">
                    ...
                    <div style="display:flex; justify-content:space-between; font-size:0.7rem; font-weight:700;"><span>Generous</span><span>Fair</span><span>Strict</span></div>
                </div>
        ...
        <script>
            ...
            async function processAndGrade() {
                ...
                const loadInterval = setInterval(() => {
                    ...
                    progBar.style.width = ((loadIdx + 1) * 30) + "%";
